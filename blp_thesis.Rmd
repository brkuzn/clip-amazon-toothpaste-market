...
if (is_pdf) {
  ...
  summ_rows   <- data.table(
    variable = c("Quarter FEs", "Implied median $\\varepsilon$", "RSS drop vs $\\rho$=0"),
    M1 = c("Yes", "$-$2.62", "---"),
    M2 = c("Yes", "$\\approx -4.0$", "3.1\\%"),
    M3 = c("Yes", "$\\approx -7.9$", "8.1\\%")
  )
  ...
  summ_rows   <- data.table(
    variable = c("Quarter FEs", "Implied median elasticity", "RSS drop vs rho=0"),
    M1 = c("Yes", "-2.62", "--"),
    M2 = c("Yes", "approx -4.0", "3.1%"),
    M3 = c("Yes", "approx -7.9", "8.1%")
  )
